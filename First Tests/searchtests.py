...
class HomePageTests(unittest.TestCase):
    ...
    def setUp(self):
        self.driver = webdriver.Chrome(executable_path = r'C://Users//USER//proyectos//selenium//First Tests//chromedriver.exe')
        driver = self.driver
...
if __name__ == "__main__":
        unittest.main(verbosity = 2, testRunner = HTMLTestRunner(output = 'reportes', report_name = 'search-tests-report'))